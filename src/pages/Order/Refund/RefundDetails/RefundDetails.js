            ...
            <Col xs={24} sm={24} md={24} lg={24} xl={24}>
              <div className={styles.RefundDetailsBoxDetailsMsg}>
                ...
                <div className={styles.RefundDetailsBoxDetailsMsgImg}>
                  <img alt="" onClick={() => {
                    this.showCancel('http://qmcsdcr.oss-cn-beijing.aliyuncs.com/2019121309bd04982e124914a9e644e475467eeb.jpg');
                  }} src="http://qmcsdcr.oss-cn-beijing.aliyuncs.com/2019121309bd04982e124914a9e644e475467eeb.jpg" />
                </div>
              </div>
            </Col>
          </Row>
