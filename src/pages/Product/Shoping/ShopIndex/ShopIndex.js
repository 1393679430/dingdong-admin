      ...
      <div className={styles.ShopIndex}>
        <div className={styles.ShopIndexBox}>
          ...
          <Row style={{ marginBottom: '15px' }}>
            <Col xs={24} sm={24} md={24} lg={24} xl={24}>
              <Table columns={columns} dataSource={this.state.dataList} onChange={this.onChangePage}
        ...
        >
          ...
          <div style={{ display: 'flex' }}>
            ...
            <InputNumber style={{ flex: '1' }} step={0.01} precision={2} min={0.00} max={9999.99}
                         value={this.state.vip_price} onChange={this.vipChange} />
          </div>
